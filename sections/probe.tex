...
Predictive ROBust Estimation is a technique that improves localization accuracy in the presence of such effects by building a model of the uncertainty in the affected visual observations. 
...
\For{$s\gets 1, N_{path}$}
	\State $f_1, \dots, f_J \gets \text{sample_features}(l)$
