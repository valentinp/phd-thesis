...
\begin{figure*}
    ...
    \subfigure[Reprojection error of checkerboard corners triangulated from the VI-Sensor and reprojected into the Flea3.] {
        \includegraphics[width=0.45\textwidth]{probe/reprojectionError}
    ...
    \subfigure[Tracking error of KLT-tracked checkerboard corners in the left VI-Sensor camera compared to directly re-detected corners.] {
        \includegraphics[width=0.45\textwidth]{probe/trackingError}
...
\begin{figure}
    \centering
    \includegraphics[width=0.4\textwidth]{probe/flowPredictorCombined.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.4\textwidth]{probe/highFreqPredictor.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth]{probe/city-res-road.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.4\textwidth]{probe/husky2}
...
\begin{figure}
    \centering
      \includegraphics[width=0.45\textwidth]{probe-gk/system_overview}
...
\begin{figure}
\centering
   \includegraphics[width=0.45\textwidth]{probe-gk/sim_world.pdf}
   \label{fig:SimWorld} 
...
\begin{figure}
    \centering
    \includegraphics[width=0.45\textwidth]{probe-gk/simComparison_sim_rerun}
...
\begin{figure}
    \centering
    \includegraphics[width=0.45\textwidth]{probe-gk/{kittiComparison-0011-0009-15-Sep-2015-4way}}
...
\begin{figure}
    \centering
    \includegraphics[width=0.45\textwidth]{probe-gk/{kittiComparison-0035-0036-15-Sep-2015-4way}}
...
\begin{figure}
    \centering
    \includegraphics[width=0.45\textwidth]{probe-gk/{kittiComparison-0070-0028-15-Sep-2015-4way}}
...
\begin{figure}
    \centering
    \hspace*{0.25cm}
    \includegraphics[width=0.45\textwidth]{probe-gk/experiment_wide_border}
...
\begin{figure}
    \centering
	\includegraphics[width=0.45\textwidth]{probe-gk/xb3_rtk_fig}
...
\begin{figure}
    \centering
    \includegraphics[width=0.45\textwidth]{probe-gk/{trainingStats}}
