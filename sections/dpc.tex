...
\begin{equation}
	\label{eq:se3loss_fn}
\CostFunction (\Transform, \TargetCorrection) = \CostFunction (\PredictionVector, \TargetCorrection) = \frac{1}{2} \LogMapFunction{\PredictionVector}^T \Inv{\TransformCovariance} \LogMapFunction{\PredictionVector},
\end{equation} where 
\begin{equation}
