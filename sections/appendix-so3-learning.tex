...
\begin{figure*}
	\centering
	\includegraphics[width=0.98\textwidth]{supplementary/uncertainty_methods.pdf}
	\vspace{-.5em}
...
\begin{figure}
	\centering
	\includegraphics[width=0.48\textwidth]{supplementary/uncertainty-MSE}
...
\begin{figure}
	\centering
	\includegraphics[width=0.48\textwidth]{supplementary/uncertainty-NLL-target_noise}
...
\begin{figure*}[h!]
	...
	\begin{subfigure}[]{\textwidth}
		\includegraphics[width=\textwidth]{supplementary/supp_dropout.pdf}
		\caption{Dropout}
		\label{fig:1D_dropout}
	\end{subfigure}
	\hfill
	\begin{subfigure}[]{\textwidth}
		\includegraphics[width=\textwidth]{supplementary/supp_sigma.pdf}
		\caption{Direct Uncertainty}
		\label{fig:1D_direct}
	\end{subfigure}
	\hfill
	\begin{subfigure}[]{\textwidth}
		\includegraphics[width=\textwidth]{supplementary/supp_bagging.pdf}
		\caption{Bagging}
		\label{fig:1D_bagging}
	\end{subfigure}
	\hfill	
	\begin{subfigure}[]{\textwidth}
		\includegraphics[width=\textwidth]{supplementary/supp_hydranet.pdf}
		\caption{HydraNet (no direct uncertainty)}
		\label{fig:1D_hydranet_undirect}
	\end{subfigure}
	\hfill
	\begin{subfigure}[]{\textwidth}
		\includegraphics[width=\textwidth]{supplementary/supp_hydranetsigma.pdf}
		\caption{HydraNet}
...
\begin{figure*}[h!]
	...
	\begin{subfigure}[]{0.33\textwidth}
		\includegraphics[width=\textwidth]{supplementary/7scenes_abs_best_model_chess_heads_25_epoch_13}
		\caption{Chess}
	\end{subfigure}
	\begin{subfigure}[]{0.33\textwidth} 
		\includegraphics[width=\textwidth]{supplementary/7scenes_abs_best_model_fire_heads_25_epoch_4}
		\caption{Fire}
	\end{subfigure}
	\begin{subfigure}[]{0.33\textwidth} 
		\includegraphics[width=\textwidth]{supplementary/7scenes_abs_best_model_heads_heads_25_epoch_11}
		\caption{Heads}
	\end{subfigure}
	\begin{subfigure}[]{0.33\textwidth} 
		\includegraphics[width=\textwidth]{supplementary/7scenes_abs_best_model_office_heads_25_epoch_15}
		\caption{Office}
	\end{subfigure}
	\begin{subfigure}[]{0.33\textwidth} 
		\includegraphics[width=\textwidth]{supplementary/7scenes_abs_best_model_pumpkin_heads_25_epoch_13}
		\caption{Pumpkin}
	\end{subfigure}
	\begin{subfigure}[]{0.33\textwidth} 
		\includegraphics[width=\textwidth]{supplementary/7scenes_abs_best_model_redkitchen_heads_25_epoch_2}
		\caption{Kitchen}
	\end{subfigure}
	\begin{subfigure}[]{0.33\textwidth} 
		\includegraphics[width=\textwidth]{supplementary/7scenes_abs_best_model_stairs_heads_25_epoch_11}
		\caption{Stairs}
	\end{subfigure}
...
\begin{figure*}[h!]
	\centering
	\begin{subfigure}[]{0.33\textwidth}
		\includegraphics[width=\textwidth]{supplementary/kitti_abs_00_downsample_5}
		\caption{\texttt{00}}
	\end{subfigure}
	\begin{subfigure}[]{0.33\textwidth} 
		\includegraphics[width=\textwidth]{supplementary/kitti_abs_02_downsample_5}
		\caption{\texttt{02}}
	\end{subfigure}
	\begin{subfigure}[]{0.33\textwidth} 
		\includegraphics[width=\textwidth]{supplementary/kitti_abs_05_downsample_5}
		\caption{\texttt{05}}
	\end{subfigure}
	\begin{subfigure}[]{0.33\textwidth} 
		\includegraphics[width=\textwidth]{supplementary/kitti_00_topdown}
		\caption{\texttt{00}}
	\end{subfigure}
	\begin{subfigure}[]{0.33\textwidth} 
		\includegraphics[width=\textwidth]{supplementary/kitti_02_topdown}
		\caption{\texttt{02}}
	\end{subfigure}
	\begin{subfigure}[]{0.33\textwidth} 
		\includegraphics[width=\textwidth]{supplementary/kitti_05_topdown}
		\caption{\texttt{05}}
	\end{subfigure}
