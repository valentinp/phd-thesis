...
%%%%%%%%%%%%      INCLUDE ONLY        %%%%%%%%%%%%
\includeonly{sections/introduction,sections/math}
...
\begin{notation}
    ...
    \nitem{ \Transform_{ab}}{ The $4 \times 4$ transformation matrix that transforms homogeneous points from $\CoordinateFrame{b}$ to $\CoordinateFrame{a}$: $\boldsymbol{p}_a^{ca} = \Transform_{ab} \boldsymbol {p}_b^{cb}$. }
\end{notation}
%\printnomenclature
