...
\begin{notation}
    ...
    \nitem{ \Vector p_{a}^{c,b} }{ A vector from point $b$ to point $c$ (denoted by the superscript) and expressed in $\CoordinateFrame{a}$ (denoted by the subscript). This vector can be in homogenous coordinates depending on context. }
