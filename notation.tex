...
\NewDocumentCommand\PROBEPoseError{}{\epsilon}
...
\NewDocumentCommand\ImageLandmark{mm}{
    	\Vector{y}_{#1, #2}
}
...
\NewDocumentCommand\GeneralCovariance{}{\Matrix{\Sigma}}
...
\NewDocumentCommand\ProjectionFunction{}{\Vector{f}}
...
%% General
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\NewDocumentCommand\MeasurementCovariance{}{\Matrix{R}}
\NewDocumentCommand\MeasurementJacobian{}{\Matrix{G}}

\NewDocumentCommand\MotionCovariance{}{\Matrix{Q}}
\NewDocumentCommand\MotionModel{}{\Vector{f}}
\NewDocumentCommand\MotionJacobian{}{\Matrix{F}}

\NewDocumentCommand\KFState{}{\Vector{x}}
\NewDocumentCommand\KFStateCovariance{}{\Matrix{P}}


\NewDocumentCommand\DeepMeasurementModel{}{\Matrix{g}}
\NewDocumentCommand\SensorData{}{\Vector{z}}



\NewDocumentCommand\MatLog{m}{\mathrm{Log}\left({#1}\right)}
\NewDocumentCommand\MatExp{m}{\mathrm{Exp}\left({#1}\right)}
\NewDocumentCommand\Matlog{m}{\mathrm{log}\left({#1}\right)^{\vee}}
\NewDocumentCommand\Matexp{m}{\mathrm{exp}\left({#1}^{\wedge}\right)}
\NewDocumentCommand\matlogexp{mm}{\MatLog{\MatExp{#1} \MatExp{#2}}}
\NewDocumentCommand\matlogexpfn{mm}{g(#1, #2)}
...
\NewDocumentCommand\RotDist{m}{d_\mathrm{#1}}
\NewDocumentCommand\quat{}{\Vector{q}}
\NewDocumentCommand\Covd{}{\Matrix{\Sigma}_a}
\NewDocumentCommand\Covh{}{\Matrix{\Sigma}_e}
\NewDocumentCommand\sigmad{}{\sigma_a}
\NewDocumentCommand\sigmah{}{\sigma_e}
...
\newcommand\Transpose[1]{ \left.{#1}\right.^\Tr }
...
%Common notation
\newcommand\GenericParameters[0]{\Matrix{\pi}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% UTIAS Notation
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\newcommand\RotationAxisVector[0]{ \Vector{a} }
...
\newcommand\Tr[0]{{\mkern-1.0mu\mathsf{T}}}


%%
\newcommand\NeuralNetwork[0]{\mathtt{NN}}
